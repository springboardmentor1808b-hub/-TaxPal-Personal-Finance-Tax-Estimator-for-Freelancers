...
const Profile = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    email: user?.email || "",
    phone: user?.phone || "Not Provided", // Real field check
    address: user?.address || "Not Provided" // Real field check
  });
    ...
    <div className="flex min-h-screen bg-[#fdfaf5] font-sans text-slate-700">
      ...
      <main className="flex-1 ml-64 p-10">
        <header className="mb-10">
          <h2 className="text-4xl font-black text-[#1a1a1a]">My Profile</h2>
          ...
          <div className="p-8 relative">
            ...
            <div className="mt-16 flex justify-between items-start">
              <div>
                ...
                <p className="text-gray-500 font-medium capitalize">{user?.role || "Member"} User</p>
              </div>
              <button 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <ProfileField 
                ...
                label="Full Name" 
                value={isEditing ? 
                  <input className="bg-white border rounded p-1 w-full" value={`${formData.firstName} ${formData.lastName}`} readOnly /> 
                  : `${formData.firstName} ${formData.lastName}`
                } 
              />
              <ProfileField 

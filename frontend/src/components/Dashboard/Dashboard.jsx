...
const Dashboard = () => {
    ...
    // State to store summary of finances (income, expense, tax)
    ...
    useEffect(() => {
        ...
        if (!storedUser) {
            ...
            // Set user state
            setUser(storedUser);
            // TODO: Later, fetch total income/expense/tax from backend
        }
    }, [navigate]);
    ...
    return (
        <div className="min-h-screen bg-[#fafafa] font-sans">
            ...
            <main className="max-w-5xl mx-auto p-6">
                ...
                {/* Quick Stats Cards: Total Income, Expenses, Tax */}
                ...
                {/* Action Buttons for Adding Income or Expense */}

        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="group p-10 bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-emerald-500/10 hover:border-emerald-100 transition-all duration-300">
              <div className="w-14 h-14 bg-emerald-100 rounded-2xl flex items-center justify-center text-3xl mb-6 group-hover:scale-110 transition-transform">
                📊
              </div>
              ...
              <p className="text-gray-600 leading-relaxed">
                Log transactions, categorize expenses and monitor your financial
                flow in real-time.
              </p>
            </div>
            ...
            <div className="group p-10 bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-emerald-500/10 hover:border-emerald-100 transition-all duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Set monthly spending limits and track performance with clear
                financial insights.
              </p>
            </div>
            ...
            <div className="group p-10 bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-emerald-500/10 hover:border-emerald-100 transition-all duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Instantly calculate quarterly tax estimates based on your income
                and expense data.
              </p>
            </div>
          </div>
            ...
            {[
              {
                ...
                desc: "Sign up securely for your dashboard",
              },
              {
                num: 2,
                title: "Log Data",
              ...
              },
              {
                ...
                desc: "Monitor your spending trends",
              },
              {
                num: 4,
                title: "Get Estimates",
                desc: "Generate quarterly tax reports",
              },
            ].map((step) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="order-2 md:order-1">
              ...
              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                TaxPal is built with industry-standard encryption. Your
                financial data remains protected through secure authentication.
              </p>

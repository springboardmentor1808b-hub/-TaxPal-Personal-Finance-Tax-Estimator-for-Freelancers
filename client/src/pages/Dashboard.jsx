        ...
        <>
          ...
          <div className="grid grid-cols-3 gap-3 mb-5">
            <div className="bg-emerald-50 rounded-2xl p-3 text-center">
              ...
              <div className="text-[9px] font-black text-emerald-500 uppercase tracking-widest mt-0.5">
                Healthy
              </div>
            </div>
            <div className="bg-orange-50 rounded-2xl p-3 text-center">
              ...
              <div className="text-[9px] font-black text-orange-400 uppercase tracking-widest mt-0.5">
                Warning
              </div>
            </div>
          ...
          <div className="space-y-2 mb-5 flex-1">
            {budgetData.slice(0, 3).map((b) => (
              ...
              >
                ...
                />
                <span className="text-[11px] font-black text-slate-600 flex-1 truncate uppercase tracking-wide">
                  {b.name}
                </span>
                <span
                  className={`text-[10px] font-black ${b.remaining < 0 ? "text-rose-500" : "text-slate-400"}`}
                >

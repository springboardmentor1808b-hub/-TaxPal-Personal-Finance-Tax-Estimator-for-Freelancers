...
function Avatar({ name, email }) {
  ...
  return (
    <div
      className="w-9 h-9 rounded-xl flex items-center justify-center text-white text-[13px] font-black flex-shrink-0 shadow-md"
      style={{
    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 px-4 space-y-0.5 overflow-y-auto">
          <p className="px-4 text-[9px] font-black text-gray-300 uppercase tracking-[0.22em] mb-3">
            Main Menu
          </p>
        ...
        <div className="mx-4 mb-5 mt-3">
          <div className="bg-gray-50 rounded-2xl border border-gray-100 overflow-hidden">
            ...
            <div className="flex items-center gap-3 px-4 py-3.5">
              ...
              {/* Online dot */}
              <span
                className="w-2 h-2 bg-emerald-400 rounded-full flex-shrink-0 shadow-sm shadow-emerald-200"
                title="Online"
              />
            </div>
